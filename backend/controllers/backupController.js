...
const formatValueForMySQL = (value) => {
  ...
  // Handle Buffer objects (image data)
  if (
    value &&
    typeof value === "object" &&
    value.type === "Buffer" &&
      ...
      res.status(200).json({
        ...
        message:
          missingTables.length > 0
            ? `Backup created with ${missingTables.length} missing table(s) skipped`
