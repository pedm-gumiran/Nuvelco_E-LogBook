...
export default function ChangePasswordModal({ isOpen, onClose }) {
  ...
  const isFormValid = formData.newPassword.trim() && formData.confirmPassword && !error;
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex items-center justify-between">
          ...
          <Btn_X onClick={onClose} className="text-white/80 hover:text-white hover:bg-white/10 p-1 rounded-full transition-colors" disabled={loading} />
        </div>
          ...
          {success ? (
            ...
            <>
              ...
              <Input_Password
                ...
                password_className={error ? 'border-red-300 focus:ring-red-200' : ''}
              />
              {error && (
